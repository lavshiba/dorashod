...
- массовые действия пока без полной боевой логики переноса / удаления / снятия подкатегории
- часть категорийного, подкатегорийного и карточечного flow ещё не доведена до конца
- custom period parsing и часть тяжёлых веток импорта ещё не доведены до полного соответствия ТЗ
